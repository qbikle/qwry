...
- **A1 · Ask (v1)** — read-only question → SQL → answer panel. Gate: `EVAL.md` PR gate green; staging hybrid ≥ 22/23 on mid and large tiers.
  ...
  - ✓ (W2, 09-05, built, awaiting taste pass) UI: Ask panel card, answer anatomy, assumption chips, sanity line, trace drawer, follow-ups, Fix It, provider/model picker, Settings › Models
